...
- `plugin-boilerplate.pot` - Template file containing all translatable strings
- `plugin-boilerplate-{locale}.po` - Translation files for specific languages (e.g., `plugin-boilerplate-es_ES.po` for Spanish)
- `plugin-boilerplate-{locale}.mo` - Compiled translation files (generated from .po files)
...
```bash
wp i18n make-pot . languages/plugin-boilerplate.pot --domain=wpseed
```

Or using the makepot command:

```bash
php wp-content/plugins/plugin-boilerplate/bin/makepot.php
```

## Creating a New Translation

1. Copy `plugin-boilerplate.pot` to `plugin-boilerplate-{locale}.po` (e.g., `plugin-boilerplate-fr_FR.po` for French)
...
2. Open `plugin-boilerplate.pot`
3. Create new translation from template
4. Save as `plugin-boilerplate-{locale}.po`
...
wp i18n make-po languages/plugin-boilerplate.pot languages/plugin-boilerplate-es_ES.po
