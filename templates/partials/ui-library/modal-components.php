...
<div class="plugin-boilerplate-ui-section">
    ...
    <div class="plugin-boilerplate-component-group">
        ...
        <div class="component-demo">
            ...
            <button class="plugin-boilerplate-button plugin-boilerplate-button-primary" id="open-demo-modal"><?php esc_html_e('Open Modal', 'plugin-boilerplate'); ?></button>
            ...
            <div id="ui-library-demo-modal" class="plugin-boilerplate-modal" style="display:none;">
                <div class="plugin-boilerplate-modal-content">
                    ...
                    <div class="plugin-boilerplate-modal-footer">
                        <button class="plugin-boilerplate-button plugin-boilerplate-button-secondary close-demo-modal"><?php esc_html_e('Cancel', 'plugin-boilerplate'); ?></button>
                        <button class="plugin-boilerplate-button plugin-boilerplate-button-primary"><?php esc_html_e('Save Changes', 'plugin-boilerplate'); ?></button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="component-demo">
            ...
            <button class="plugin-boilerplate-button plugin-boilerplate-button-secondary" id="open-task-modal"><?php esc_html_e('View Task Details', 'plugin-boilerplate'); ?></button>
            ...
            <div id="ui-library-task-modal" class="plugin-boilerplate-modal" style="display:none;">
                <div class="plugin-boilerplate-modal-content">
                    ...
                    <div class="plugin-boilerplate-modal-footer">
                        <button class="plugin-boilerplate-button plugin-boilerplate-button-secondary close-task-modal"><?php esc_html_e('Close', 'plugin-boilerplate'); ?></button>
                        <button class="plugin-boilerplate-button plugin-boilerplate-button-primary"><?php esc_html_e('Edit Task', 'plugin-boilerplate'); ?></button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="component-demo">
            ...
            <button class="plugin-boilerplate-button plugin-boilerplate-button-secondary" id="open-loading-modal"><?php esc_html_e('Show Loading', 'plugin-boilerplate'); ?></button>
        ...
        <div class="component-demo">
            ...
            <button class="plugin-boilerplate-button plugin-boilerplate-button-danger" id="open-confirm-modal"><?php esc_html_e('Delete Item', 'plugin-boilerplate'); ?></button>
            ...
            <div id="ui-library-confirm-modal" class="plugin-boilerplate-modal" style="display:none;">
                <div class="plugin-boilerplate-modal-content">
                    ...
                    <div class="plugin-boilerplate-modal-footer">
                        <button class="plugin-boilerplate-button plugin-boilerplate-button-secondary close-confirm-modal"><?php esc_html_e('Cancel', 'plugin-boilerplate'); ?></button>
                        <button class="plugin-boilerplate-button plugin-boilerplate-button-danger"><?php esc_html_e('Delete', 'plugin-boilerplate'); ?></button>
                    </div>
                </div>
            </div>
        </div>
