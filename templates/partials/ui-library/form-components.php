        ...
        <div class="plugin-boilerplate-form-showcase">
            <form method="post" action="" class="plugin-boilerplate-demo-form">
                ...
                <div class="plugin-boilerplate-form-actions">
                    <button type="submit" class="plugin-boilerplate-button plugin-boilerplate-button-primary"><?php esc_html_e('Send Message', 'plugin-boilerplate'); ?></button>
                </div>
            </form>
        </div>
    </div>
    ...
    <div class="plugin-boilerplate-component-group">
        ...
        <div class="plugin-boilerplate-form-showcase">
            <form method="post" action="" class="plugin-boilerplate-demo-form">
                ...
                <div class="plugin-boilerplate-form-actions">
                    <button type="submit" class="plugin-boilerplate-button plugin-boilerplate-button-primary"><?php esc_html_e('Save Settings', 'plugin-boilerplate'); ?></button>
                    <button type="reset" class="plugin-boilerplate-button plugin-boilerplate-button-secondary"><?php esc_html_e('Reset', 'plugin-boilerplate'); ?></button>
                </div>
            </form>
        </div>
    </div>
    ...
    <div class="plugin-boilerplate-component-group">
        ...
        <div class="plugin-boilerplate-form-showcase">
            <form id="ajax-validation-form" class="plugin-boilerplate-demo-form">
                ...
                <div class="plugin-boilerplate-form-actions">
                    <button type="submit" class="plugin-boilerplate-button plugin-boilerplate-button-primary" id="ajax-submit-btn"><?php esc_html_e('Validate & Submit', 'plugin-boilerplate'); ?></button>
                </div>
            </form>
        </div>
    </div>
