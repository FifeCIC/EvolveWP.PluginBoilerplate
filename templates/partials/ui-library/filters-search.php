                ...
                <div class="filter-panel">
                    ...
                    <div class="filter-panel-content">
                        ...
                        <div class="filter-actions">
                            <button type="button" class="plugin-boilerplate-button plugin-boilerplate-button-secondary"><?php esc_html_e('Reset', 'plugin-boilerplate'); ?></button>
                            <button type="button" class="plugin-boilerplate-button plugin-boilerplate-button-primary"><?php esc_html_e('Apply Filters', 'plugin-boilerplate'); ?></button>
                        </div>
                    </div>
                </div>
            </div>
