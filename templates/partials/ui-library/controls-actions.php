        ...
        <div class="component-demo">
            ...
            <div class="control-panel control-panel-expanded">
                ...
                <div class="control-panel-footer">
                    <button class="plugin-boilerplate-button plugin-boilerplate-button-small plugin-boilerplate-button-secondary"><?php esc_html_e('Reset', 'plugin-boilerplate'); ?></button>
                    <button class="plugin-boilerplate-button plugin-boilerplate-button-small plugin-boilerplate-button-primary"><?php esc_html_e('Apply', 'plugin-boilerplate'); ?></button>
                </div>
            </div>
        </div>
    </div>
