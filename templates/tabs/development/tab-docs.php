...
class EvolveWP_Boilerplate_Admin_Development_Docs {
    ...
    public static function output() {
        $docs_dir = PLUGIN_BOILERPLATE_PLUGIN_DIR_PATH . 'docs/';
        ...
        ?>
        <div class="plugin-boilerplate-docs-viewer">
            <div class="plugin-boilerplate-docs-sidebar">
                <h3><?php esc_html_e('Documentation', 'plugin-boilerplate'); ?></h3>
                <?php self::render_docs_menu($docs_dir, $current_doc); ?>
            </div>
            
            <div class="plugin-boilerplate-docs-content">
                <?php self::render_doc_content($docs_dir, $current_doc); ?>
            </div>
        </div>
        
        <style>
            .plugin-boilerplate-docs-viewer {
                display: flex;
                gap: 20px;
                margin-top: 20px;
            }
            .plugin-boilerplate-docs-sidebar {
                width: 250px;
                background: #fff;
                padding: 20px;
            ...
            .plugin-boilerplate-docs-sidebar h3 {
                margin-top: 0;
                padding-bottom: 10px;
                border-bottom: 2px solid #0073aa;
            }
            .plugin-boilerplate-docs-sidebar ul {
                list-style: none;
                margin: 0;
                padding: 0;
            }
            .plugin-boilerplate-docs-sidebar li {
                margin: 0;
                padding: 0;
            }
            .plugin-boilerplate-docs-sidebar a {
                display: block;
                padding: 8px 12px;
            ...
            .plugin-boilerplate-docs-sidebar a:hover {
                background: #f0f0f0;
            }
            .plugin-boilerplate-docs-sidebar a.active {
                background: #0073aa;
                color: #fff;
                font-weight: 600;
            }
            .plugin-boilerplate-docs-content {
                flex: 1;
                background: #fff;
                padding: 30px;
                border: 1px solid #ddd;
            ...
            .plugin-boilerplate-docs-content h1 {
                margin-top: 0;
                padding-bottom: 15px;
                border-bottom: 2px solid #0073aa;
            }
            .plugin-boilerplate-docs-content h2 {
                margin-top: 30px;
                color: #0073aa;
            }
            .plugin-boilerplate-docs-content pre {
                background: #f5f5f5;
                padding: 15px;
                border-left: 3px solid #0073aa;
                overflow-x: auto;
            }
            .plugin-boilerplate-docs-content code {
                background: #f5f5f5;
                padding: 2px 6px;
                border-radius: 3px;
                font-size: 0.9em;
            }
            .plugin-boilerplate-docs-content pre code {
                background: none;
                padding: 0;
            }
            .plugin-boilerplate-docs-content table {
                width: 100%;
                border-collapse: collapse;
                margin: 20px 0;
            }
            .plugin-boilerplate-docs-content table th,
            .plugin-boilerplate-docs-content table td {
                padding: 10px;
                border: 1px solid #ddd;
                text-align: left;
            }
            ...
            .plugin-boilerplate-docs-content blockquote {
    ...
    private static function render_docs_menu($docs_dir, $current_doc) {
        $docs = array(
            'GETTING-STARTED' => __('Getting Started', 'plugin-boilerplate'),
            'REPEATER-FIELDS' => __('Repeater Fields', 'plugin-boilerplate'),
            'REPEATER-QUICK-REFERENCE' => __('Repeater Quick Ref', 'plugin-boilerplate'),
            'ADVANCED-FEATURES' => __('Advanced Features', 'plugin-boilerplate'),
            'INTEGRATIONS' => __('Integrations', 'plugin-boilerplate'),
            'DEVELOPER-CHECKLIST' => __('Developer Checklist', 'plugin-boilerplate'),
            'ECOSYSTEM' => __('Ecosystem', 'plugin-boilerplate'),
            'UNIFIED-FEATURE' => __('Unified Feature', 'plugin-boilerplate'),
            'DOCUMENTATION-STANDARD' => __('Doc Standards', 'plugin-boilerplate'),
        );
    ...
    private static function render_doc_content($docs_dir, $current_doc) {
        ...
        if (!file_exists($file_path)) {
            echo '<p>' . esc_html__('Documentation file not found.', 'plugin-boilerplate') . '</p>';
            return;
        }
