...
- ✅ Custom post types (example: plugin_boilerplate_item)
- ✅ Custom taxonomies (example: plugin_boilerplate_category)
- ✅ Custom user roles
...
### For Immediate Use
1. **Rename the plugin** - Find/replace plugin-boilerplate" with your plugin name
