...
### Access Endpoint
```
GET /wp-json/plugin-boilerplate/v1/myendpoint
```
...
function my_register_cpt() {
    register_post_type('book', array(
        'labels' => array(
            'name' => __('Books', 'plugin-boilerplate'),
            'singular_name' => __('Book', 'plugin-boilerplate'),
        ),
        'public' => true,
        'has_archive' => true,
...
function my_register_taxonomy() {
    register_taxonomy('genre', 'book', array(
        'labels' => array(
            'name' => __('Genres', 'plugin-boilerplate'),
            'singular_name' => __('Genre', 'plugin-boilerplate'),
        ),
        'public' => true,
        'hierarchical' => true,
        'show_in_rest' => true,
...
```php
__('Text', 'plugin-boilerplate');
_e('Text', 'plugin-boilerplate');
_n('Singular', 'Plural', $count, 'plugin-boilerplate');
esc_html__('Text', 'plugin-boilerplate');
esc_html_e('Text', 'plugin-boilerplate');
```

### Generate POT File
```bash
wp i18n make-pot . languages/plugin-boilerplate.pot
```
...
└── plugin-boilerplate.php            # Plugin entry point
```
...
- **Development Dashboard**: `wp-admin/admin.php?page=plugin-boilerplate-development`
- **Notification Center**: `wp-admin/admin.php?page=plugin-boilerplate-notifications`
- **Settings**: `wp-admin/admin.php?page=plugin-boilerplate-settings`
...
- Check task is scheduled: `wp-admin/admin.php?page=plugin-boilerplate-development&tab=tasks`
- Ensure hook is registered with `add_action()`

### Notifications Not Showing
- Check database table exists: `wp_plugin_boilerplate_notifications`
