...
[![PRs Welcome](https://img.shields.io/badge/PRs-welcome-brightgreen.svg)](https://github.com/ryanbayne/plugin-boilerplate/pulls)
...
# plugin-boilerplate" → "myawesomeplugin"
...
- [Download Latest Release](https://github.com/fifecic/plugin-boilerplate/releases/latest)
- [View Changelog](CHANGELOG.md)
- [Read Documentation](docs/)
- [Watch Video Tutorial](https://youtube.com/watch?v=...)
- [Report an Issue](https://github.com/fifecic/plugin-boilerplate/issues/new)
- [Request a Feature](https://github.com/fifecic/plugin-boilerplate/issues/new?labels=enhancement)
...
- Change plugin name: Find & replace plugin-boilerplate" throughout
...
[⭐ Star on GitHub](https://github.com/ryanbayne/wpseed) • [📖 Read Docs](docs/) • [🐛 Report Bug](https://github.com/ryanbayne/plugin-boilerplate/issues) • [💡 Request Feature](https://github.com/ryanbayne/plugin-boilerplate/issues)
