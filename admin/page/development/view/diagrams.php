...
class EvolveWP_Core_Admin_Development_Diagrams {
    ...
    public static function output() {
        ...
        wp_enqueue_script('mermaid', PLUGIN_BOILERPLATE_PLUGIN_URL . 'assets/js/mermaid.min.js', array(), '10.0.0', true);
        ?>
            ...
            <div class="diagram-controls">
                <select id="diagram-selector" class="regular-text">
                    <optgroup label="Architecture">
                        <option value="plugin-structure"><?php esc_html_e('Plugin Structure', 'plugin-boilerplate'); ?></option>
                        <option value="class-hierarchy"><?php esc_html_e('Class Hierarchy', 'plugin-boilerplate'); ?></option>
                        <option value="hook-system"><?php esc_html_e('Hook System', 'plugin-boilerplate'); ?></option>
                    </optgroup>
                    <optgroup label="Data Flow">
                        <option value="data-flow"><?php esc_html_e('Data Flow Architecture', 'plugin-boilerplate'); ?></option>
                        <option value="rest-api-flow"><?php esc_html_e('REST API Flow', 'plugin-boilerplate'); ?></option>
                        <option value="admin-flow"><?php esc_html_e('Admin Interface Flow', 'plugin-boilerplate'); ?></option>
                    </optgroup>
                    <optgroup label="Systems">
                        <option value="logging-system"><?php esc_html_e('Logging System', 'plugin-boilerplate'); ?></option>
                        <option value="ai-integration"><?php esc_html_e('AI Integration', 'plugin-boilerplate'); ?></option>
                        <option value="asset-management"><?php esc_html_e('Asset Management', 'plugin-boilerplate'); ?></option>
                    </optgroup>
                </select>
                <button id="fullscreen-btn" class="button"><?php esc_html_e('Fullscreen', 'plugin-boilerplate'); ?></button>
                <button id="export-btn" class="button"><?php esc_html_e('Export SVG', 'plugin-boilerplate'); ?></button>
            </div>
        ...
        <style>
        .plugin-boilerplate-diagrams-container { max-width: 100%; margin: 20px 0; }
        ...
        jQuery(document).ready(function($) {
                ...
                'logging-system': {
                    ...
                    mermaid: `
                        flowchart TD
                            ...
                            D --> G[File: plugin-boilerplate-errors.log]
                            E --> H[File: plugin-boilerplate-info.log]
                            F --> I[File: plugin-boilerplate-debug.log]
                            
                            B --> J[Database Logger]
                            J --> K[wp_plugin_boilerplate_logs table]
            ...
            $('#export-btn').on('click', function() {
                ...
                if (svg) {
                    ...
                    a.href = url;
                    a.download = 'plugin-boilerplate-diagram.svg';
                    a.click();
