...
| `reset.css` | core | Yes | All --tp- refs need replacing with --plugin-boilerplate- |
| `typography.css` | core | Yes | All --tp- refs need replacing with --plugin-boilerplate- |
...
| `plugin-boilerplate-setup.css` | core | Setup wizard |
| `plugin-boilerplate-setup.scss` | **dead** | SCSS source — no build pipeline |
...
| `js/admin/plugin-boilerplate-enhanced-select.js` | core | Select2 wrapper |
| `js/admin/plugin-boilerplate-enhanced-select.min.js` | core | Minified version |
| `js/admin/plugin-boilerplate-faq.js` | feature | FAQ accordion |
| `js/admin/plugin-boilerplate-faq.min.js` | feature | Minified version |
| `js/admin/plugin-boilerplate-setup.js` | core | Setup wizard JS |
| `js/admin/plugin-boilerplate-setup.min.js` | core | Minified version |
...
- **Task 7.2** ✅ — All `--tp-` variable refs replaced with `--plugin-boilerplate-` (46 CSS files)
- **Task 7.2** ✅ — All `.tp-` class names replaced with `.plugin-boilerplate-` (6 CSS, 1 JS, 7 PHP templates)
- **Task 7.3** ✅ — `variables.css` cleaned: removed self-referencing aliases, trading vars,
  duplicate swatches. Added `--plugin-boilerplate-focus-ring` and `--plugin-boilerplate-color-accent`.
