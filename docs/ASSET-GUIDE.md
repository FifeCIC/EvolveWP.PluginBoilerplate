...
```css
/* Primary brand */
--plugin-boilerplate-color-primary        /* #2271b1 — WordPress blue */
--plugin-boilerplate-color-primary-dark
--plugin-boilerplate-color-primary-light

/* Accent (secondary brand) */
--plugin-boilerplate-color-accent
--plugin-boilerplate-color-accent-dark
--plugin-boilerplate-color-accent-light

/* Semantic */
--plugin-boilerplate-color-success         /* Green */
--plugin-boilerplate-color-warning         /* Amber */
--plugin-boilerplate-color-error           /* Red */
--plugin-boilerplate-color-info            /* Blue */

/* Neutral scale */
--plugin-boilerplate-color-gray-50 through --plugin-boilerplate-color-gray-900
--plugin-boilerplate-color-white
--plugin-boilerplate-color-black

/* Status backgrounds (for notice boxes) */
--plugin-boilerplate-status-success-bg / -border / -text
--plugin-boilerplate-status-warning-bg / -border / -text
--plugin-boilerplate-status-error-bg   / -border / -text
--plugin-boilerplate-status-info-bg    / -border / -text
```

### Spacing tokens

```css
--plugin-boilerplate-spacing-xs    /* 4px */
--plugin-boilerplate-spacing-sm    /* 8px */
--plugin-boilerplate-spacing-md    /* 12px */
--plugin-boilerplate-spacing-lg    /* 16px */
--plugin-boilerplate-spacing-xl    /* 20px */
--plugin-boilerplate-spacing-2xl   /* 24px */
--plugin-boilerplate-spacing-3xl   /* 32px */
```

### Typography tokens

```css
--plugin-boilerplate-font-family-base   /* System font stack */
--plugin-boilerplate-font-family-mono   /* Consolas, Monaco, monospace */
--plugin-boilerplate-font-size-xs through --plugin-boilerplate-font-size-3xl
--plugin-boilerplate-font-weight-normal / -medium / -semibold / -bold
--plugin-boilerplate-line-height-tight / -normal / -relaxed
```
...
```css
/* Borders */
--plugin-boilerplate-border-radius / -sm / -md / -lg / -xl / -full
--plugin-boilerplate-border-standard   /* 1px solid gray-300 */

/* Shadows */
--plugin-boilerplate-shadow-sm / (default) / -md / -lg / -xl

/* Transitions */
--plugin-boilerplate-transition-fast / -normal / -slow

/* Focus (accessibility) */
--plugin-boilerplate-focus-ring          /* 2px solid primary */
--plugin-boilerplate-focus-ring-offset   /* 1px */

/* Z-index scale */
--plugin-boilerplate-z-index-dropdown / -modal / -popover / -tooltip / -toast
```
...
All CSS classes use the `.plugin-boilerplate-` prefix to avoid conflicts with themes
and other plugins. When cloned, the prefix changes to the plugin's own
(e.g. `.plugin-boilerplate-`).

Pattern: `.plugin-boilerplate-{component}-{element}--{modifier}`

```css
/* Component */
.plugin-boilerplate-card { }

/* Element within component */
.plugin-boilerplate-card-header { }
.plugin-boilerplate-card-body { }
.plugin-boilerplate-card-footer { }

/* Modifier */
.plugin-boilerplate-card-interactive { }

/* State */
.plugin-boilerplate-button:disabled { }
.plugin-boilerplate-button-loading { }
```
...
| `'plugin_boilerplate_development'` | Development page only |
| `'plugin_boilerplate_settings'` | Settings page only |
| `'plugin_boilerplate_dashboard'` | Dashboard page only |
...
'my-component' => array(
    ...
    'pages'        => array( 'plugin_boilerplate_development' ),
...
These are the components every plugin inherits. They use `--plugin-boilerplate-*` variables
...
1. All `.plugin-boilerplate-` class prefixes become your plugin's prefix
2. All `--plugin-boilerplate-` CSS variables become your plugin's prefix
