...
```php
define( 'PLUGIN_BOILERPLATE_LICENSE_SERVER', 'https://your-server.com' );
define( 'PLUGIN_BOILERPLATE_PRODUCT_ID', 'plugin-boilerplate-plugin' );
```
...
### Activate License
```
POST /wp-json/plugin-boilerplate-license/v1/activate
```
...
### Deactivate License
```
POST /wp-json/plugin-boilerplate-license/v1/deactivate
```

### Check License Status
```
POST /wp-json/plugin-boilerplate-license/v1/check
```
...
### Check for Updates
```
POST /wp-json/plugin-boilerplate-license/v1/update_check
```
...
### Get Plugin Info
```
POST /wp-json/plugin-boilerplate-license/v1/plugin_info
```

### Get License Info
```
POST /wp-json/plugin-boilerplate-license/v1/info
```
...
### List Extensions
```
GET /wp-json/plugin-boilerplate-extensions/v1/list
```
...
### Download Extension
```
POST /wp-json/plugin-boilerplate-extensions/v1/download
```
...
```php
check_admin_referer( 'plugin_boilerplate_license_action' );
```
...
```php
add_filter( 'plugin_boilerplate_license_validation', function( $is_valid, $license_key ) {
...
```php
add_filter( 'plugin_boilerplate_update_check_interval', function( $interval ) {
...
```php
add_filter( 'plugin_boilerplate_extensions_list', function( $extensions ) {
...
2. Check update check transient: `plugin_boilerplate_license_check_{product_id}`
