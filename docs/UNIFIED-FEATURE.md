...
```
[plugin_boilerplate_feature]
[plugin_boilerplate_feature title="Custom Title"]
[plugin_boilerplate_feature show_icon="no"]
[plugin_boilerplate_feature show_stats="no"]
```
