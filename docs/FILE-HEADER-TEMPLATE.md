 ...
 * DATA FLOW:
 *   Input  → none
 *   Output → defines PLUGIN_BOILERPLATE_* constants, requires vendor/autoload.php and loader.php
 *
 * @package  WPSeed
 * @since    1.0.0
 */
 ...
 *
 * CONSUMED BY:
 *   - Hook: wp_ajax_plugin_boilerplate_save_settings
 *
 * DATA FLOW:
...
<?php
/**
 * Plugin settings storage — reads and writes the plugin_boilerplate_settings option.
 *
 * ROLE: data-model
 *
 ...
 * DATA FLOW:
 *   Input  → get_option( 'plugin_boilerplate_settings' )
 *   Output → update_option( 'plugin_boilerplate_settings', $data )
 *
 * @package  WPSeed
 * @category Core
 * @since    1.0.0
 ...
 * CONSUMED BY:
 *   - Hook: rest_api_init
 *   - Route: GET/POST /wp-json/plugin-boilerplate/v1/settings
 *
 * DATA FLOW:
 ...
 *   - Hook: plugin_boilerplate_ecosystem_register
 *
 * DATA FLOW:
