...
```php
array(
    'title'           => __( 'Social Media Links', 'plugin-boilerplate' ),
    'desc'            => __( 'Add your social media profiles.', 'plugin-boilerplate' ),
    'id'              => 'plugin_boilerplate_social_links',
    'type'            => 'repeater',
    'item_title'      => __( 'Social Link', 'plugin-boilerplate' ),
    'add_button_text' => __( 'Add Social Link', 'plugin-boilerplate' ),
    'fields'          => array(
        array(
            'id'          => 'platform',
            'label'       => __( 'Platform', 'plugin-boilerplate' ),
            'type'        => 'text',
            'placeholder' => __( 'e.g., Facebook', 'plugin-boilerplate' ),
        ),
        array(
            'id'          => 'url',
            'label'       => __( 'Profile URL', 'plugin-boilerplate' ),
            'type'        => 'url',
            'placeholder' => __( 'https://...', 'plugin-boilerplate' ),
        ),
    ),
)
```
...
```php
array(
    'title'           => __( 'API Credentials', 'plugin-boilerplate' ),
    'desc'            => __( 'Add multiple API credentials.', 'plugin-boilerplate' ),
    'id'              => 'plugin_boilerplate_api_credentials',
    'type'            => 'repeater',
    'item_title'      => __( 'API Credential', 'plugin-boilerplate' ),
    'add_button_text' => __( 'Add API Credential', 'plugin-boilerplate' ),
    'fields'          => array(
        array(
            'id'          => 'service_name',
            'label'       => __( 'Service Name', 'plugin-boilerplate' ),
            'type'        => 'text',
            'placeholder' => __( 'e.g., Stripe', 'plugin-boilerplate' ),
        ),
        array(
            'id'          => 'api_key',
            'label'       => __( 'API Key', 'plugin-boilerplate' ),
            'type'        => 'text',
        ),
        array(
            'id'      => 'environment',
            'label'   => __( 'Environment', 'plugin-boilerplate' ),
            'type'    => 'select',
            'options' => array(
                'sandbox'    => __( 'Sandbox', 'plugin-boilerplate' ),
                'production' => __( 'Production', 'plugin-boilerplate' ),
            ),
            'default' => 'sandbox',
        ),
        array(
            'id'          => 'enabled',
            'type'        => 'checkbox',
            'description' => __( 'Enable this credential', 'plugin-boilerplate' ),
            'default'     => 1,
        ),
    ),
)
...
```php
$items = get_option( 'plugin_boilerplate_social_links', array() );
...
```css
.plugin-boilerplate-repeater-item {
    /* Custom item styling */
}

.plugin-boilerplate-repeater-item-header {
...
```javascript
jQuery(document).on('plugin_boilerplate_repeater_item_added', function(e, $item) {
    // Item was added
});

jQuery(document).on('plugin_boilerplate_repeater_item_removed', function(e, $item) {
    // Item was removed
});
```
...
- GitHub Issues: https://github.com/ryanbayne/plugin-boilerplate/issues
- Documentation: https://github.com/ryanbayne/plugin-boilerplate/docs
