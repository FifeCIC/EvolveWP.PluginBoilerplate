...
* @version 1.0
*/
function plugin_boilerplate_string_half( $string, $ret = null ) {        
    $a = array();
 ...
 */
function plugin_boilerplate_normalize_postcode( $postcode ) {          
 ...
 * @return string
 */
function plugin_boilerplate_format_phone_number( $tel ) {            
 ...
 * @return string
 */
function plugin_boilerplate_strtolower( $string ) {                    
 ...
 * @return string
 */
function plugin_boilerplate_trim_string( $string, $chars = 200, $suffix = '...' ) {      
 ...
 * @return string|array
 */
function plugin_boilerplate_clean( $var ) {
    if ( is_array( $var ) ) {
        return array_map( 'plugin_boilerplate_clean', $var );
    } else {
