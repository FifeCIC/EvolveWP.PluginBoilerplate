...
* @return boolean 
*/
function plugin_boilerplate_is_extensionloaded( $giving_extension ){      
...
* @param url $url
*/
function plugin_boilerplate_is_url( $url ){            
...
* @returns boolean
*/
function plugin_boilerplate_is_decimalnumber( $img_url){       
...
* @returns boolean
*/
function plugin_boilerplate_is_image_url( $img_url ){       
