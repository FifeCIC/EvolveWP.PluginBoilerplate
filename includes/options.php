...
trait EvolveWP_Core_OptionsTrait {
    ...
    */
    private static $grouped_options = array(      
        'compact' => 'plugin_boilerplate_options',
        'private' => 'plugin_boilerplate_private_options',
    );
    ...
    */
    public static function get_option_names( $type = 'compact' ) {           
        switch ( $type ) {
            ...
            //Individual options here, will be prepended with plugin-boilerplate".
            case 'non_compact' :
                return array(
    ...
    */
    ...
    /**
     * Returns the requested option.  Looks in plugin_boilerplate_options group 
     * or plugin_boilerplate_$name as appropriate.
     *
     * @version 1.2
    ...
    public static function get_option( $name, $default = false, $maybe_unserialize = true ) {
        ...
        if ( self::is_valid( $name, 'non_compact' ) ) {
            $option_value = get_option( "plugin_boilerplate_$name", $default );
    ...
    */                               
     ...
     * Updates plugin_boilerplate_options or plugin_boilerplate_$name as appropriate.
     *
     * @since   1.0.0
     * @version 1.2.0
     *
    ...
    public function update_option( $name, $value, $autoload = null ) {
        if ( self::is_valid( $name, 'non_compact' ) ) {
            ...
            if ( version_compare( $GLOBALS['wp_version'], '4.2', '>=' ) ) {
                return update_option( "plugin_boilerplate_$name", $value, $autoload );
            }
            return update_option( "plugin_boilerplate_$name", $value );
        }
     ...
     * Updates plugin_boilerplate_options and/or deletes plugin_boilerplate_$name as appropriate.
     *
     * @since   1.0.0
     * @version 1.2.0
     *
    ...
    public function delete_option( $names ) {
        ...
        foreach ( array_intersect( $names, self::get_option_names( 'non_compact' ) ) as $name ) {
            if ( ! delete_option( "plugin_boilerplate_$name" ) ) {
                $result = false;
            }
        }
