...
class Capability_Manager {
	 ...
	 *                            plugin prefix (e.g. 'plugin_boilerplate_manage_settings').
	 * @param  array  $args {
	...
	public static function register_defaults() {
		...
		self::register_many( array(
			...
			'plugin_boilerplate_manage_settings' => array(
				'label'       => __( 'Manage Settings', 'plugin-boilerplate' ),
				'description' => __( 'Access and modify the plugin settings page.', 'plugin-boilerplate' ),
				'grant_to'    => array( 'administrator' ),
				'group'       => 'core',
			),
			'plugin_boilerplate_view_development' => array(
				'label'       => __( 'View Development Tools', 'plugin-boilerplate' ),
				'description' => __( 'Access the Development page with architecture, roadmap, and debug tabs.', 'plugin-boilerplate' ),
				'grant_to'    => array( 'administrator' ),
				'group'       => 'development',
			),
			'plugin_boilerplate_manage_connectors' => array(
				'label'       => __( 'Manage API Connectors', 'plugin-boilerplate' ),
				'description' => __( 'Configure API credentials and test connector connections.', 'plugin-boilerplate' ),
				'grant_to'    => array( 'administrator' ),
				'group'       => 'api',
			),
			'plugin_boilerplate_execute_connectors' => array(
				'label'       => __( 'Execute Connector Actions', 'plugin-boilerplate' ),
				'description' => __( 'Run actions on external APIs via the connector system.', 'plugin-boilerplate' ),
				'grant_to'    => array( 'administrator' ),
				'group'       => 'api',
			),
			'plugin_boilerplate_view_logs' => array(
				'label'       => __( 'View Logs', 'plugin-boilerplate' ),
				'description' => __( 'Access API call logs, debug logs, and trace output.', 'plugin-boilerplate' ),
				'grant_to'    => array( 'administrator' ),
				'group'       => 'development',
			),
		) );
	...
	public static function user_can( $capability, $user_id = null ) {
		 ...
		 */
		$override = apply_filters( 'plugin_boilerplate_user_can', null, $capability, $user_id );
	...
	public static function install() {
		 ...
		 */
		do_action( 'plugin_boilerplate_capabilities_installed', self::$capabilities );
	}
	...
	public static function uninstall() {
		 ...
		 * @param array<string, array> $capabilities All registered capabilities.
		 */
		do_action( 'plugin_boilerplate_capabilities_uninstalled', self::$capabilities );
	}
