 ...
 *   - Hook: init (fires plugin_boilerplate_task_scheduler_init action)
 *
 * DATA FLOW:
...
class Task_Scheduler {
	...
	public function init() {
		do_action( 'plugin_boilerplate_task_scheduler_init' );
	}
	 ...
	 */
	public function schedule_single( $hook, $args = array(), $timestamp = null, $group = 'plugin-boilerplate' ) {
	 ...
	 * @return int|false Action ID or false if Action Scheduler unavailable.
	 */
	public function schedule_recurring( $hook, $interval, $args = array(), $timestamp = null, $group = 'plugin-boilerplate' ) {
	 ...
	 * @return int|false Action ID or false if Action Scheduler unavailable.
	 */
	public function schedule_cron( $hook, $cron_expression, $args = array(), $timestamp = null, $group = 'plugin-boilerplate' ) {
	 ...
	 * @return bool|null
	 */
	public function unschedule( $hook, $args = array(), $group = 'plugin-boilerplate' ) {
	 ...
	 * @return void
	 */
	public function unschedule_all( $hook, $args = array(), $group = 'plugin-boilerplate' ) {
	 ...
	 */
	public function next_scheduled( $hook, $args = array(), $group = 'plugin-boilerplate' ) {
	 ...
	 * @return bool
	 */
	public function is_scheduled( $hook, $args = array(), $group = 'plugin-boilerplate' ) {
