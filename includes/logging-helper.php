...
class EvolveWP_Boilerplate_Logging_Helper {
    ...
    public static function log_app($message, $context = array()) {
        if (get_option('plugin_boilerplate_logging_enabled', 'yes') !== 'yes') {
            return;
        }
    ...
    public static function log_api($action, $endpoint, $details = array()) {
        if (get_option('plugin_boilerplate_logging_api', 'yes') !== 'yes') {
            return;
        }
    ...
    public static function log_error($error_code, $error_message, $context = array()) {
        if (get_option('plugin_boilerplate_logging_errors', 'yes') !== 'yes') {
            return;
        }
    ...
    public static function log_debug($message, $data = null) {
        if (get_option('plugin_boilerplate_logging_debug', 'no') !== 'yes') {
            return;
        }
    ...
    private static function write_log($filename, $message) {
        $log_dir = defined('PLUGIN_BOILERPLATE_LOG_DIR') ? PLUGIN_BOILERPLATE_LOG_DIR : WP_CONTENT_DIR . '/plugin-boilerplate-logs/';
