...
namespace EvolveWP\PluginBoilerplate\API;
...
class REST_Bridge {
	 ...
	 * @since  3.1.0
	 *
	 * @param  string $namespace REST namespace (e.g. 'plugin-boilerplate/v1').
	 ...
	 *     @type string   $capability  Capability required. Checked via plugin_boilerplate_user_can().
	 ...
	 *                                      Default 'plugin_boilerplate_execute_connectors'.
	 *     @type string $capability_manage  Capability for test/capabilities.
	 *                                      Default 'plugin_boilerplate_manage_connectors'.
	 * }
	 * @return void
	 */
	public static function register_connector_routes( $namespace, $provider_id, $args = array() ) {
		$defaults = array(
			'capability_execute' => 'plugin_boilerplate_execute_connectors',
			'capability_manage'  => 'plugin_boilerplate_manage_connectors',
		);
	...
	public static function register_all_routes() {
		 ...
		 * @since 3.1.0
		 */
		do_action( 'plugin_boilerplate_rest_bridge_before_register' );
		 ...
		 */
		do_action( 'plugin_boilerplate_rest_bridge_registered', self::$endpoints );
	}
	...
	private static function make_permission_callback( $capability ) {
		...
		return static function () use ( $capability ) {
			return \plugin_boilerplate_user_can( $capability );
		};
	}
