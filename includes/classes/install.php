...
class EvolveWP_Core_Install { 
    ...
    */
    ...
    /**
     * Forced plugin update action triggered by the force_update_plugin-boilerplate GET parameter.
     *
     ...
     * The nonce action 'plugin_boilerplate_force_update' must be present in the URL; callers
    ...
    public static function install_action_updater_cron() {
        ...
        // Prefixed hook name — renamed from wp_plugin_boilerplate_updater_cron to satisfy NonPrefixedHooknameFound.
     ...
     * 
     * Requires PLUGIN_BOILERPLATE_WORDPRESSORG_SLUG to be defined.  
     * 
     * Code adapted from W3 Total Cache.
     * 
     * @uses PLUGIN_BOILERPLATE_WORDPRESSORG_SLUG
     * @uses wp_kses_post()
     */
     ...
     */
     private static function get_core_capabilities() {
        ...
        $capabilities['core'] = array(
            'manage_plugin-boilerplate',
            'code_plugin-boilerplate',
        );
    ...
    private static function create_files() {
        ...
        $files = array(
            array(
                'base'         => $upload_dir['basedir'] . '/plugin_boilerplate_uploads',
                'file'         => 'index.html',
                'content'     => ''
            ),
            array(
                'base'         => PLUGIN_BOILERPLATE_LOG_DIR,
                'file'         => '.htaccess',
    ...
    /**
     * Create database tables for API logging
     */
