...
class EvolveWP_Core_Architecture_Mapper {
                    ...
                    'ai_system' => array(
                        ...
                        'children' => array(
                            ...
                            'usage_tracker' => array(
                                ...
                                'tables' => array('plugin_boilerplate_ai_usage'),
                    ...
                    'api_system' => array(
                        ...
                        'children' => array(
                            ...
                            'api_logging' => array(
                                ...
                                'tables' => array('plugin_boilerplate_api_calls', 'plugin_boilerplate_api_errors'),
                    ...
                    'rest_api' => array(
                        ...
                        'children' => array(
                            'rest_controller' => array(
                                ...
                                'namespace' => 'plugin-boilerplate/v1',
                    ...
                    'logging_system' => array(
                        ...
                        'children' => array(
                            'file_logging' => array(
                                ...
                                'type' => 'component',
                                'file' => 'includes/logging-helper.php',
                                'functions' => array('plugin_boilerplate_log', 'plugin_boilerplate_log_error'),
                                'log_location' => 'wp-content/uploads/plugin-boilerplate-logs/'
                            ),
                            'database_logging' => array(
                                'name' => 'Database Logging',
                                'type' => 'component',
                                'tables' => array('plugin_boilerplate_logs'),
            ...
            'admin_pages' => array(
                ...
                'children' => array(
                    'development_page' => array(
                        ...
                        'menu_slug' => 'plugin-boilerplate-development',
                        'children' => array(
                            'assets_tab' => array(
                                'name' => 'Assets Tab',
                                'type' => 'tab',
                    ...
                    'settings_page' => array(
                        ...
                        'menu_slug' => 'plugin-boilerplate-settings',
                        'children' => array(
                            'general_tab' => array(
                                'name' => 'General Tab',
                                'type' => 'tab',
                    ...
                    'github_sync' => array(
                        ...
                        'menu_slug' => 'plugin-boilerplate-github-sync',
                    ...
                    'learning_centre' => array(
                        ...
                        'menu_slug' => 'plugin-boilerplate-learning',
                        'purpose' => 'Database-driven lessons with REST API export',
                        'tables' => array('plugin_boilerplate_lessons')
                    )
                )
            ),
            'wordpress_features' => array(
                ...
                'children' => array(
                    'custom_post_types' => array(
                        ...
                        'example' => 'plugin_boilerplate_example_cpt',
                    ...
                    'taxonomies' => array(
                        ...
                        'type' => 'feature',
                        'file' => 'includes/classes/install.php',
                        'example' => 'plugin_boilerplate_example_taxonomy',
                    ...
                    'shortcodes' => array(
                        ...
                        'example' => '[plugin_boilerplate_example]',
                    ...
                    'user_roles' => array(
                        ...
                        'type' => 'feature',
                        'file' => 'includes/classes/install.php',
                        'example' => 'plugin_boilerplate_custom_role',
            ...
            'developer_tools' => array(
                ...
                'children' => array(
                    'wp_cli' => array(
                        ...
                        'commands' => array('wp plugin-boilerplate info', 'wp plugin-boilerplate cache clear'),
                    ...
                    'developer_mode' => array(
                        ...
                        'detection' => 'Checks for localhost, custom domains, or PLUGIN_BOILERPLATE_DEV_MODE constant'
                    ),
                    'uninstall_feedback' => array(
                        ...
                        'tables' => array('plugin_boilerplate_uninstall_feedback')
                    ),
    ...
    public static function render_tree() {
        ...
        echo '<div class="plugin-boilerplate-architecture-tree">';
    ...
    private static function get_tree_styles() {
        return "
        .plugin-boilerplate-architecture-tree {
