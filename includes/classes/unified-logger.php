...
function plugin_boilerplate_js_log_helper() {
    if (!plugin_boilerplate_is_developer_mode()) return;
    ?>
    <script>
    window.PluginBoilerplateLogger = {
        context: '',
        loopCounters: {},
...
// Initialize
add_action('admin_footer', 'plugin_boilerplate_js_log_helper');
