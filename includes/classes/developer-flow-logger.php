...
class EvolveWP_Boilerplate_Developer_Flow_Logger {
    ...
    public static function start_flow( $context, $description = '' ) {
        if ( ! plugin_boilerplate_is_developer_mode() ) {
            return;
        }
    ...
    private static function display_flow() {
        ...
        echo '<div class="plugin-boilerplate-flow-log">';
        ...
        echo '</div>';
        echo '<style>
        .plugin-boilerplate-flow-log { margin: 20px 0; padding: 15px; background: #f8f9fa; border: 1px solid #dee2e6; border-radius: 5px; font-family: monospace; font-size: 12px; }
